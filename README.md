...
- [x] **Meal Grouping (DB Ready):** Implement the UI to group multiple food items into a saved "Meal" (e.g. "Default Breakfast") to log them all at once.
- [x] **Editable Profile:** Allow the user to edit their profile metrics (Weight, Goals) and recalculate goals after onboarding is complete.
